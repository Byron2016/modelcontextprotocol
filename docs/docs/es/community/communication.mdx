---
title: "Comunicación del Contribuidor"
description: "Estrategia y marco de comunicación para la comunidad del Protocolo de Contexto del Modelo (Model Context Protocol)"
---
