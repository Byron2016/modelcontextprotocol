---
title: "Conéctate a servidores MCP locales"
description: "Aprende a extender Escritorio Claude (Claude Desktop) con servidores MCP locales para habilitar el acceso al sistema de archivos y otras potentes integraciones."
---
