---
title: "Conéctate a servidores MCP remotos"
description: "Aprende a conectar Claude a servidores MCP remotos y a extender sus capacidades con herramientas y fuentes de datos alojadas en internet."
---
