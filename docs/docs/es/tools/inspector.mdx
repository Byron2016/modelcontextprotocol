---
title: "Inspector MCP"
description: "Guía detallada para usar el Inspector MCP en la prueba y depuración de servidores del Protocolo de Contexto del Modelo (Model Context Protocol)"
---
