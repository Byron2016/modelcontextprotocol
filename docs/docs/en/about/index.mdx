...
<div className="landing-page">
  ...
  <section className="ecosystem-section">
    ...
    <div className="stats-grid">
      <a href="/docs/en/sdk" target="_blank" className="stat-card">
        <div className="stat-number">10</div>
        <div className="stat-label">Official SDKs</div>
      </a>
      <a href="/docs/en/clients" target="_blank" className="stat-card">
  ...
  <section className="cta-buttons">
    <a href="/docs/en/getting-started/intro" className="cta-primary">
      Get Started
    </a>
  </section>
</div>
